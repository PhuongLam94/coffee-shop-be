...
var inventoriesRouter = require('./routers/inventories')
var ingredientsRouter = require('./routers/ingredients')
...
app.use(authRouter.routes())
    ...
    .use(inventoriesRouter.routes())
    .use(inventoriesRouter.allowedMethods())
    .use(ingredientsRouter.routes())
    .use(ingredientsRouter.allowedMethods())
